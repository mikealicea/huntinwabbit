...
[the home page](../../app/page.tsx), not the root layout.
...
The text identity links to the protected application. No product artwork is loaded.
...
[Header.test.tsx](Header.test.tsx) checks the application destination and logical theme switching with a
mocked next-themes boundary. [Browser tests](../../../e2e/hello.spec.ts) exercise the actual
