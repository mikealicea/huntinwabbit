...
export function BoardStatus({
  ...
  return (
    ...
    >
      <span role="status" aria-label="Board status" className="sr-only">
        {label}
      </span>
      {showError ? (
        <button
          ...
          aria-label="Board request failed. Show details"
          aria-expanded={open}
